...
@section('title', 'Editar Categoría - Sistema de Laboratorio')
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h4 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Editar Categoría de Examen
                    </h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('categorias-examen.update', $categoriasExaman) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input
                                    ...
                                    id="categoria"
                                    name="categoria"
                                    value="{{ old('categoria', $categoriasExaman->categoria) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input
                                    ...
                                    id="orden"
                                    name="orden"
                                    value="{{ old('orden', $categoriasExaman->orden) }}"
                                    min="1"
                                    required
                                >
                                @error('orden')
                        ...
                        <div class="mb-3">
                            ...
                            >{{ old('descripcion', $categoriasExaman->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-switch">
                                <input
                                    ...
                                    name="status"
                                    value="1"
                                    {{ old('status', $categoriasExaman->status) == '1' ? 'checked' : '' }}
                                >
