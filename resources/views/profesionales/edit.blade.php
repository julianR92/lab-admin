...
@section('title', 'Editar Profesional - Sistema de Laboratorio')
        ...
        <div class="col-md-10">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('profesionales.update', $profesionale) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="nombre"
                                    name="nombre"
                                    value="{{ old('nombre', $profesionale->nombre) }}"
                                    required
                                >
                                @error('nombre')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="apellido"
                                    name="apellido"
                                    value="{{ old('apellido', $profesionale->apellido) }}"
                                    required
                                >
                                @error('apellido')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="documento"
                                    name="documento"
                                    value="{{ old('documento', $profesionale->documento) }}"
                                    required
                                >
                                @error('documento')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="profesion"
                                    name="profesion"
                                    value="{{ old('profesion', $profesionale->profesion) }}"
                                    required
                                >
                                @error('profesion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('registro_profesional', $profesionale->registro_profesional) }}"
                                    required
                                >
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input
                                    ...
                                    id="especialidad"
                                    name="especialidad"
                                    value="{{ old('especialidad', $profesionale->especialidad) }}"
                                >
                                @error('especialidad')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                @if($profesionale->firma_digital)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $profesionale->firma_digital) }}" alt="Firma actual" class="img-thumbnail" style="max-height: 100px;">
                                        <p class="text-muted small mb-0">Firma actual (sube una nueva para reemplazarla)</p>
                                    </div>
                                @endif
                                <input
                                    type="file"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="telefono"
                                    name="telefono"
                                    value="{{ old('telefono', $profesionale->telefono) }}"
                                >
                                @error('telefono')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    id="email"
                                    name="email"
                                    value="{{ old('email', $profesionale->email) }}"
                                >
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-switch">
                                <input
                                    ...
                                    name="status"
                                    value="1"
                                    {{ old('status', $profesionale->status) == '1' ? 'checked' : '' }}
                                >
