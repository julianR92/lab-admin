...
@section('title', 'Nueva IPS - Sistema de Laboratorio')
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h4 class="mb-0">
                        <i class="fas fa-hospital me-2"></i>Registrar Nueva IPS
                    </h4>
                </div>
                    ...
                    <form action="{{ route('ips.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Clínica del Norte S.A.S."
                                    required
                                >
                                @error('razon_social')
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Guardar IPS
                            </button>
                        </div>
                    </form>
                </div>
