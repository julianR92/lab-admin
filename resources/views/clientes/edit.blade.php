                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('tipo_documento') is-invalid @enderror"
                                    ...
                                    <option value="PT" {{ old('tipo_documento', $cliente->tipo_documento) == 'PT' ? 'selected' : '' }}>Permiso Temporal</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('ips_id') is-invalid @enderror"
                                    ...
                                    @foreach($ipsList as $ipsItem)
                                        <option value="{{ $ipsItem->id }}" {{ old('ips_id', $cliente->ips_id) == $ipsItem->id ? 'selected' : '' }}>
